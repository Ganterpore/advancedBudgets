...
`INSERT INTO account_type_budget("account", "regularBudget", "budgetMax", "frequency", "frequencyCategory", "startDate", "endDate", "dayOf", "type")
                VALUES($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING id`,
    [props.account, props.regularBudget, props.budgetMax === null ? null : Math.round(props.budgetMax), props.frequency, props.frequencyCategory, props.startDate, props.endDate, props.dayOf, props.type])
...
export async function updateBudgetAccount (budgetAccount: AccountTypeBudget): Promise<void> {
  ...
  await db.query(
    `UPDATE account_type_budget SET 
        ("account", "regularBudget", "budgetMax", "frequency", "frequencyCategory", "startDate", "endDate", "dayOf", "type") 
        = ($1, $2, $3, $4, $5, $6, $7, $8, $9)
        WHERE ID=$10`,
    [
      budgetAccount.account,
      budgetAccount.regularBudget,
      budgetAccount.budgetMax === null ? null : Math.round(budgetAccount.budgetMax),
      budgetAccount.frequency,
      budgetAccount.frequencyCategory,
      budgetAccount.startDate,
      budgetAccount.endDate,
      budgetAccount.dayOf,
      budgetAccount.type,
      budgetAccount.id
    ])
